...
CREATE TABLE events ( event_id INT PRIMARY KEY AUTO_INCREMENT, event_name VARCHAR(50) NOT NULL, event_description TEXT NOT NULL, event_target_year_levels SET('1', '2', '3', '4') NOT NULL DEFAULT '1,2,3,4', event_start_date DATE NOT NULL, event_end_date DATE, event_picture VARCHAR(255) DEFAULT 'default.jpg', event_sanction_has_comserv BOOLEAN NOT NULL DEFAULT FALSE, organization_id INT NOT NULL, FOREIGN KEY (organization_id) REFERENCES organizations(organization_id) ON DELETE CASCADE ON UPDATE CASCADE ) AUTO_INCREMENT = 1001;

CREATE TABLE students ( student_id INT PRIMARY KEY AUTO_INCREMENT, student_number_id VARCHAR(10) UNIQUE NOT NULL, user_id INT NOT NULL, student_section VARCHAR(3) NOT NULL, student_current_program INT NULL, last_active DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE ON UPDATE CASCADE, FOREIGN KEY (student_current_program) REFERENCES programs(program_id) ON DELETE SET NULL ON UPDATE CASCADE ) AUTO_INCREMENT = 1001;
...
CREATE TABLE event_contributions ( event_contri_id INT PRIMARY KEY AUTO_INCREMENT, event_contri_due_date DATE NOT NULL, event_contri_fee DECIMAL(10,2) NOT NULL, event_contri_sanction_fee DECIMAL(10,2) NOT NULL DEFAULT 0, event_id INT NOT NULL, FOREIGN KEY (event_id) REFERENCES events(event_id) ON DELETE CASCADE ON UPDATE CASCADE ) AUTO_INCREMENT = 1001;

CREATE TABLE event_attendance ( event_attend_id INT PRIMARY KEY AUTO_INCREMENT, event_attend_date DATE NOT NULL, event_attend_time ENUM('AM IN', 'AM OUT', 'PM IN', 'PM OUT') NOT NULL DEFAULT 'AM IN', event_attend_sanction_fee DECIMAL(10,2) NOT NULL DEFAULT 0, event_id INT NOT NULL, FOREIGN KEY (event_id) REFERENCES events(event_id) ON DELETE CASCADE ON UPDATE CASCADE ) AUTO_INCREMENT = 1001;

CREATE TABLE paid_attendance_sanctions ( paid_attend_sanction_id INT PRIMARY KEY AUTO_INCREMENT, event_attend_id INT NOT NULL, student_id INT NOT NULL, paid_sanction_amount DECIMAL(10,2) NOT NULL, payment_type VARCHAR(20), online_payment_proof VARCHAR(255), paid_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (event_attend_id) REFERENCES event_attendance(event_attend_id) ON DELETE CASCADE ON UPDATE CASCADE, FOREIGN KEY (student_id) REFERENCES students(student_id) ON DELETE CASCADE ON UPDATE CASCADE ) AUTO_INCREMENT = 1001;
...
CREATE TABLE contributions_made ( contribution_id INT PRIMARY KEY AUTO_INCREMENT, event_contri_id INT NOT NULL, student_id INT NOT NULL, paid_amount DECIMAL(10,2) NOT NULL DEFAULT 0, payment_type VARCHAR(20), online_payment_proof VARCHAR(255), paid_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (event_contri_id) REFERENCES event_contributions(event_contri_id) ON DELETE CASCADE ON UPDATE CASCADE, FOREIGN KEY (student_id) REFERENCES students(student_id) ON DELETE CASCADE ON UPDATE CASCADE ) AUTO_INCREMENT = 1001;

CREATE TABLE paid_contribution_sanctions ( paid_contri_sanction_id INT PRIMARY KEY AUTO_INCREMENT, student_id INT NOT NULL, event_contri_id INT NOT NULL, paid_sanction_amount DECIMAL(10,2) NOT NULL DEFAULT 0, payment_type VARCHAR(20), online_payment_proof VARCHAR(255), paid_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (student_id) REFERENCES students(student_id) ON DELETE CASCADE ON UPDATE CASCADE, FOREIGN KEY (event_contri_id) REFERENCES event_contributions(event_contri_id) ON DELETE CASCADE ON UPDATE CASCADE ) AUTO_INCREMENT = 1001;

CREATE TABLE attendance_excuse ( attendance_excuse_id INT PRIMARY KEY AUTO_INCREMENT, attendance_excuse_reason TEXT NOT NULL, attendance_excuse_proof_file VARCHAR(255) NOT NULL, attendance_excuse_status ENUM('PENDING', 'APPROVED', 'REJECTED') NOT NULL DEFAULT 'PENDING', event_attend_id INT NOT NULL, student_id INT NOT NULL, FOREIGN KEY (event_attend_id) REFERENCES event_attendance(event_attend_id) ON DELETE CASCADE ON UPDATE CASCADE, FOREIGN KEY (student_id) REFERENCES students(student_id) ON DELETE CASCADE ON UPDATE CASCADE ) AUTO_INCREMENT = 1001;
